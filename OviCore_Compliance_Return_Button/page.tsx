...
const navItems: { key: AreaKey; label: string; icon: typeof ShieldCheck }[] = [
  ...
  { key: "competency", label: "Competency Assessment", icon: CheckCircle2 },
      ...
      <section className={styles.content}>
          ...
          <div>
            <button
              ...
              style={{
                ...
                fontWeight: 800,
                cursor: "pointer",
                boxShadow: "0 1px 2px rgba(15, 63, 45, 0.05)",
              }}
              aria-label="Return to OviCore module page"
            >
              ← Return to Modules
            </button>
        ...
        {active !== "overview" && active !== "audit" && (
          <section className={styles.sectionPlaceholder}>
            ...
            {active === "competency" && <CheckCircle2 size={30} />}
            {active === "incidents" && <Siren size={30} />}
            <h2>{navItems.find((item) => item.key === active)?.label}</h2>
            <p>
              {active === "competency"
                ? "Assess employee competency, record outcomes and evidence, manage reassessment dates and link competency status into training and audit readiness."
