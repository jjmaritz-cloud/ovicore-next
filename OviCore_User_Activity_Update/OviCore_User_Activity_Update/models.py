...
class AppUser(Base):
    ...
    last_module = Column(String(80), nullable=True)
...
class UserActivity(Base):
    ...
    event_type = Column(String(50), nullable=False, default="page_view", index=True)
    module = Column(String(80), nullable=True, index=True)
    page = Column(String(255), nullable=True)
    created_at = Column(DateTime, server_default=func.now(), index=True)

    user = relationship("AppUser", back_populates="activity_events")
