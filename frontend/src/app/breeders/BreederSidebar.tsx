...
const navSections = [
  {
    ...
    items: [
      ...
      { label: "Breeder Home", href: "/breeders" },
      { label: "Flock Register", href: "/breeders/flocks" },
    ],
  },
  {
    title: "Production",
    items: [
      { label: "Daily House Card", href: "/breeders/production" },
      { label: "Egg Forecast", href: "/breeders/egg-forecast" },
      { label: "Fertility & Hatch", href: "/breeders/fertility-hatch" },
    ],
  },
  {
    title: "Integration",
